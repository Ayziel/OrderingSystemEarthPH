    ...
    fetch('https://earthph.sdevtech.com.ph/orders/getOrders')
        ...
        .then(orders => {
            ...
            if (currentMonthOrders.length === 0) {
                console.log('No orders from this month.');
                return;
            }

            currentMonthOrders.sort((a, b) => new Date(a.orderDate) - new Date(b.orderDate));
            populateOrders(currentMonthOrders);
        })
...
function exportToExcel() {
    ...
    fetch('https://earthph.sdevtech.com.ph/orders/getOrders')
        ...
        .then(orders => {
            ...
            XLSX.writeFile(wb, 'This_Month_Orders_Export.xlsx');
        })
        .catch(error => {
